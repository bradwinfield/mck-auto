...
vshpere_server = os.environ["vsphere_server"]
vshpere_namespace = os.environ["vsphere_namespace"]
...
pmsg.notice("Please make sure that DNS is updated to show " + supervisor_cluster + " resolves to " + supervisor_cluster_ip + ".")
...
pmsg.blue("kubectl vsphere login --server " + supervisor_cluster_ip + " --vsphere-username <yourloginID> --insecure-skip-tls-verify")
pmsg.normal("  Workload Cluster Login:")
pmsg.blue("kubectl vsphere login --server " + supervisor_cluster_ip + " --vsphere-username <yourloginID> --insecure-skip-tls-verify --tanzu-kubernetes-cluster-namespace " + vsphere_namespace + " --tanzu-kubernetes-cluster-name " + workload_cluster)
